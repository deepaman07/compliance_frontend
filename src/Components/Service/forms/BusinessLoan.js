...
const PersonalLoan = (props) => {
  ...
  const fetchLeads = async () => {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_LOCALHOST_SERVER}/product/readfinancialservices/${SubProductId}/${JSON.parse(Cookies.get("userCookie")).token.FINCode
      }`,
      requestOptions
    );
